...
export const RESUME_DATA = {
  ...
  projects: [
...

    {
      ...
      description:
        "A collaborative storytelling experience, where users together contribute to a story that is then, with artwork, generated by AI. The users can see how the story evolves and the AI's interpretation of it.",
      link: {
        label: "Let's Create A Story",
        href: "https://github.com/perstarkse/lets-create-a-story/",
      },
    },
    {
      title: "PolitikerStöd",
      ...
      description:
        "Providing a tool for politicians to gain more knowledge about local and national policy documents, law, etc.",
      link: {
        label: "PolitikerStöd",
        href: "https://politikerstod.perstark.xyz/",
      },
    },
    {
